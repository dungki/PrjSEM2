...
<div class="page-container">
            ...
            <div class="container-fluid">
                <div class="header-wrap">
                  <ul class="breadcrumb">
                    ...
                    <li><a href="#"><i class="fas fa-plus-circle"></i> Add bonus history</a></li>
    ...
    <div class="main-content">
      <h2 class="title-1 m-b-25" style="text-align:center;">Add bonus history</h2>
        <div class="container" style="background:#333;padding: 60px;border-radius: 10px;">
            <div class="panel-body" style="color:white;">
              <form class="" action="index.html" method="post">
                ...
                <div class="form-group">
                  <label for="usr_id">Salary id:</label>
                  <input required="true" type="text" class="form-control" id="usr_id" placeholder="...">
                </div>
