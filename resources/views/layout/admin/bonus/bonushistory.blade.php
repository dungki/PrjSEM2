...
<div class="page-container">
            ...
            <div class="container-fluid">
                <div class="header-wrap">
                  <ul class="breadcrumb">
                    ...
                    <li><a href="#"><i class="fas fa-gift"></i> Bonus</a></li>
                    <li><a href="#"><i class="fas fa-history"></i> Bonus history</a></li>
    ...
    <!-- MAIN CONTENT-->
        <div class="main-content">
          <h2 class="title-1 m-b-25" style="text-align:center;">Bonus history</h2>
          <div class="main-container100" style="display: block;margin-left:auto;margin-right:auto">
            <div class="panel-body">
              <div style="padding:60px;">
                ...
                <a href="addb_history.html" class="btn btn-dark" style="border-radius:20px;"><i class="fas fa-plus"></i> Add more</a>
              </div>
          </div>
    </div>
        </div>
