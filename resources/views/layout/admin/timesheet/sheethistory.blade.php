...
<div class="page-container">
            ...
            <div class="container-fluid">
                <div class="header-wrap">
                  <ul class="breadcrumb">
                    ...
                    <li><a href="#"><i class="far fa-calendar"></i> Timesheet</a></li>
                    <li><a href="#"><i class="fas fa-history"></i> Timesheet history</a></li>
    ...
    <!-- MAIN CONTENT-->
        <div class="main-content">
          <h2 class="title-1 m-b-25" style="text-align:center;">Timesheet history</h2>
