    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                          <ul class="breadcrumb">
                            ...
                            <li><a href="#"><i class="fas fa-users-cog"></i> Chỉnh sửa thông tin cái nhân</a></li>
                          </ul>
            ...
            <div class="main-content">
                <h2 class="title-1 m-b-25" style="text-align:center;">Chỉnh sửa thông tin</h2>
                <div class="container" style="border-radius: 10px;">
                    <div class="panel-body" style="color:black;">
                      <form class="" action="{{ route('saveProfile') }}" method="POST">
                          {{ csrf_field() }}
                          <div class="row">
                            <div class="col-sm-5">
                            <div class="form-group">
                              <label for="email">Email:</label>
                            <input required="true" type="text" name="email" value="{{$user->email}}" class="form-control" id="email" >
                          </div>
                          <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input required="true" type="text" name="address" value="{{$user->address}}" class="form-control" id="address">
                            </div>
                            <div class="form-group">
                                <label for="number">Số điện thoại:</label>
                                <input required="true" type="text" name="phone" value="{{$user->phone}}" class="form-control" id="number" >
                            </div>
                            <div class="form-group">
                                <label for="number">Ngày sinh:</label>
                                <input required="true" type="date" name="birthday" value="{{$user->birthday}}" class="form-control" id="birthday" >
                            </div>
