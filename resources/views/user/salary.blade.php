    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                          <ul class="breadcrumb">
                            ...
                            <li><a href="#"><i class="fas fa-history"></i> Lịch sử Lương</a></li>
                          </ul>
            ...
            <style>
              ...
              <h2 class="title-1 m-b-25" style="text-align:center;">Lịch sử lương</h2>
                ...
                <!-- <form style="margin-bottom:25px;">
                  ...
                  <div class="table-responsive table--no-card m-b-40">
                     ...
                     <tr>
                               ...
                               <td>{{$item->name}}</td>
                               <td>{{$item->pay_day}}</td>
                               <td><a class="btn btn-primary" href="{{ route('userDetailSalary') }}?salaryid={{$item->id}}">Chi tiết</a></td>
                      </tr>
                  @endforeach
                     @endif
                        </tbody>
